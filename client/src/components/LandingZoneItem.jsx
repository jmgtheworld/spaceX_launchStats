...
export default function LandingZoneItem(props) {
  ...
  const {id, name, full_name, locality, region,  landing_attempts, landing_successes, details, launches}  = props.pad
    ...
    <div className = "card card-body mb-3">
      <div className="row">
        <div className="col-md-9">
          ...
          <p className = "text-white"> # of Launches: {launches.length} </p> 
